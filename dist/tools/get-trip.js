...
export const getTripInputSchema = {
    ...
    day: z
        .string()
        .optional()
        .describe("Optional filter to a single day. Accepts 'day 2', 'May 4', or ISO '2026-05-04'. Omit to return the whole trip."),
    response_format: z
        .enum(["concise", "detailed"])
        .default("concise")
        .describe("Output verbosity. 'concise' (default) is a readable summary grouped by day; 'detailed' adds addresses, phone numbers, ratings, and check-in dates."),
};
...
`.trim();
export async function getTrip(ctx, args) {
    try {
...
//# sourceMappingURL=get-trip.js.map