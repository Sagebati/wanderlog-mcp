...
export function findNoteMatches(trip, query, day) {
...
function notePreview(plainText) {
    const flat = plainText.replace(/\n/g, " ").trim();
    return flat.length > 60 ? `${flat.slice(0, 57)}…` : flat;
}
export async function removeNote(ctx, args) {
    try {
...
//# sourceMappingURL=remove-note.js.map